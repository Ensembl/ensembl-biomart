...
sub get_dataset_homolog_attribute {
    ...
    my $text = << "HOMOATT_END";
      <AttributeCollection displayName="$dataset->{species_name} Orthologs" internalName="homolog_$dataset->{dataset}">
        ...
        <AttributeDescription displayName="$dataset->{species_name} start (bp)" field="chr_start_4016_r2" internalName="$dataset->{dataset}_chrom_start" key="gene_id_1020_key" maxLength="10" linkoutURL="exturl1|/*species2*/Location/View?r=$dataset->{dataset}_chromosome:$dataset->{dataset}_chrom_start-$dataset->{dataset}_chrom_end" tableConstraint="homolog_$dataset->{dataset}__dm"/>
        <AttributeDescription displayName="$dataset->{species_name} end (bp)" field="chr_end_4016_r2" internalName="$dataset->{dataset}_chrom_end" key="gene_id_1020_key" maxLength="10" linkoutURL="exturl1|/*species2*/Location/View?r=$dataset->{dataset}_hromosome:$dataset->{dataset}_chrom_start-$dataset->{dataset}_chrom_end" tableConstraint="homolog_$dataset->{dataset}__dm"/>
        ...
        <AttributeDescription displayName="dN" field="dn_4014" internalName="$dataset->{dataset}_homolog_ds" key="gene_id_1020_key" maxLength="10" tableConstraint="homolog_$dataset->{dataset}__dm"/>
        <AttributeDescription displayName="dS" field="ds_4014" internalName="$dataset->{dataset}_homolog_dn" key="gene_id_1020_key" maxLength="10" tableConstraint="homolog_$dataset->{dataset}__dm"/>
...
sub get_dataset_paralog_attribute {
    ...
    my $text = << "PARAATT_END";
      <AttributeCollection displayName="$dataset->{species_name} Paralogs" internalName="paralogs_$dataset->{dataset}">
        ...
        <AttributeDescription displayName="Paralog chromosome/scaffold" field="chr_name_4016_r2" internalName="$dataset->{dataset}_paralog_chromosome" key="gene_id_1020_key" linkoutURL="exturl1|/*species2*/Location/View?r=$dataset->{dataset}_paralog_chromosome" maxLength="40" tableConstraint="paralog_$dataset->{dataset}__dm"/>
        <AttributeDescription displayName="Paralog start (bp)" field="chr_start_4016_r2" internalName="$dataset->{dataset}_paralog_chrom_start" key="gene_id_1020_key" linkoutURL="exturl1|/*species2*/Location/View?r=$dataset->{dataset}_paralog_chromosome:$dataset->{dataset}_paralog_chrom_start-$dataset->{dataset}_paralog_chrom_end" maxLength="10" maxLength="10" tableConstraint="paralog_$dataset->{dataset}__dm"/>
        <AttributeDescription displayName="Paralog end (bp)" field="chr_end_4016_r2" internalName="$dataset->{dataset}_paralog_chrom_end" key="gene_id_1020_key" linkoutURL="exturl1|/*species2*/Location/View?r=$dataset->{dataset}_paralog_chromosome:$dataset->{dataset}_paralog_chrom_start-$dataset->{dataset}_paralog_chrom_end" maxLength="10" tableConstraint="paralog_$dataset->{dataset}__dm"/>
