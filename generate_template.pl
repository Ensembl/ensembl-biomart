...
HOMOATT_END
    ...
    # Homologue attribute section of the e! ensembl gene mart
      ...
      <AttributeDescription displayName="$dataset->{species_name} Gene-order conservation score" field="goc_score_4014" internalName="$dataset->{dataset}_homolog_goc_score" key="gene_id_1020_key" maxLength="10" tableConstraint="homolog_$dataset->{compara}__dm"/>
      <AttributeDescription displayName="$dataset->{species_name} Whole-genome alignment coverage" field="wga_coverage_4014" internalName="$dataset->{dataset}_homolog_wga_coverage" key="gene_id_1020_key" maxLength="5" tableConstraint="homolog_$dataset->{compara}__dm"/>
