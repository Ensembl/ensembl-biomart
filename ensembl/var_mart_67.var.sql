...
create table VAR_MART_DB.TEMP56 as select a.*,b.stable_id as stable_id_1023 from VAR_MART_DB.TEMP53 as a inner join CORE_DB.gene as b on a.gene_id_1020=b.gene_id;
...
create table VAR_MART_DB.TEMP60 as select a.*,b.stable_id as stable_id_1066 from VAR_MART_DB.TEMP57 as a inner join CORE_DB.transcript as b on a.transcript_id_1064=b.transcript_id;
